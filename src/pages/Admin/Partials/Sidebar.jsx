  ...
  return (
    <div>
      ...
      <div
        id="sidebar"
        ref={sidebar}
        className={`flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-72 lg:w-20 lg:sidebar-expanded:!w-72 2xl:!w-72 shrink-0 bg-slate-800 p-4 transition-all duration-200 ease-in-out ${
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex flex-shrink-0 ml-2">
                      <span className="inline-flex items-center justify-center h-6 text-sm font-semibold text-white bg-indigo-500 px-2 rounded">
                        4
                      </span>
                    </div>
                  </div>
