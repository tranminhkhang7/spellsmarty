  ...
  return (
    <div>
      ...
      <div
        id="sidebar"
        ref={sidebar}
        className={`flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-96 lg:w-20 lg:sidebar-expanded:!w-96 2xl:!w-80 shrink-0 bg-slate-800 p-4 transition-all duration-200 ease-in-out ${
      ...
      >
        ...
        <div className="space-y-8">
          {/* Pages group */}
          <div>
            <h3 className="text-2xl uppercase text-slate-500 font-semibold pl-3">
              <span
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            <span className="text-2xl font-semibold ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                              Dashboard
                            </span>
                          </div>
                          {/* Icon */}
                          <div className="flex shrink-0 ml-2">
                            <svg
                              className={`w-4 h-4 shrink-0 ml-1 fill-current text-slate-400 ${
                                open && 'rotate-180'
                              }`}
                              viewBox="0 0 12 12"
                            >
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            ...
                            >
                              <span className="text-sm font-semibold lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Main
                              </span>
                            </NavLink>
                          </li>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex flex-shrink-0 ml-2">
                      <span className="inline-flex items-center justify-center h-7 text-lg font-semibold text-white bg-indigo-500 px-2 rounded">
                        4
                      </span>
                    </div>
                  </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              <circle
                                className={`fill-current text-slate-600 ${
                                  pathname.includes('component') && 'text-indigo-500'
                                }`}
                                cx="16"
                                cy="8"
                                r="8"
                              ...
                              <circle
                                className={`fill-current text-slate-400 ${
                                  pathname.includes('component') && 'text-indigo-300'
                                }`}
                                cx="8"
                                cy="16"
                                r="8"
